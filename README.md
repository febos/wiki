...
[ContExt](https://github.com/febos/ContExt) - a lightweight and fast utility for obtaining atom-atom contacts from PDB/mmCIF files DOI: [10.1101/2025.05.30.657037](https://doi.org/10.1101/2025.05.30.657037) ([Demo](https://github.com/febos/ContExt/blob/main/demo.ipynb))
...
[JAR3D](https://rna.bgsu.edu/jar3d/) - scoring RNA loop sequences against known 3D motifs. DOI: [10.1093/nar/gkw453](http://doi.org/10.1093/nar/gkw453)

[ModeRNA](https://genesilico.pl/modernaserver/) - a tool for comparative modeling of RNA 3D structure. DOI: [10.1093/bioinformatics/btr400](http://doi.org/10.1093/bioinformatics/btr400)

[SimRNA](https://genesilico.pl/SimRNAweb) - a web server for RNA folding simulations and 3D structure modeling, with optional restraints and enhanced analysis of folding trajectories. DOI: [10.1093/nar/gkae356](http://doi.org/10.1093/nar/gkae356)

[QRNAS](https://genesilico.pl/software/stand-alone/qrnas) - software tool for refinement of nucleic acid structures. DOI: [10.1186/s12900-019-0103-1](http://doi.org/10.1186/s12900-019-0103-1)

[RNAComposer](https://rnacomposer.cs.put.poznan.pl/) - an automated template-based RNA structure modeling server. DOI: [10.1007/978-1-4939-6433-8_13](http://doi.org/10.1007/978-1-4939-6433-8_13)
